            ...
            <div className='flex-1 '>
                ...
                className="mb-2 "
                 ...
                 <div className="flex justify-end gap-2 text-xs ">
                    <Button type="button" size='sm' className="bg-gradient-to-r from-indigo-500 via-purple-500 to-blue-500"
                ...
                <div className="flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2 ">
                    ...
                    <p className="text-gray-400">{
                        comment.numberOfLikes >0 && comment.numberOfLikes + " " + (comment.numberOfLikes ===1 ? 'like' :'likes')}</p>
                        {currentUser && (currentUser._id === comment.userId|| currentUser.isAdmin) &&(<>
                            <button className="text-gray-400 hover:text-blue-500" type="button " onClick={handleEdit}> Edit</button>
                            <button className="text-gray-400 hover:text-red-500" type="button " onClick={()=>onDelete(comment._id)}> Delete</button>
                            </>) }
